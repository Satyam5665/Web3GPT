...
contract GPTMembership is ERC721 {
    ...
    string public MY_CONTRACT = "ERR_404";
    ...
    function mint(
        ...
        require(_membershipId != 0, "Membership ID cannot be zero");
        require(_membershipId <= membershipTypes, "Invalid membership ID");
        require(
            msg.value >= memberships[_membershipId].cost,
    ...
    function getUsermembership(
        address _address
    ) public view returns (UserMembership memory) {
